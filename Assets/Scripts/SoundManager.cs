...
public class SoundManager : MonoBehaviour
{
    ...
    private void PlaySound(AudioClip[] audioClipArray, Vector3 position, float volumeParameter = 1f)
    {
        AudioSource.PlayClipAtPoint(audioClipArray[Random.Range(0, audioClipArray.Length)], position, volumeParameter * volume);
    }
    ...
    public void ChangeVolume()
    {
        ...
        // PlayerPrefs saves some data in it in order to save it for the next game start
        // Save() function is not necessary but it protect SetFloat() from the in case of game crash
